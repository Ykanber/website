...
def create_app():
    ...
    app.add_url_rule("/changeteacherinfo", view_func=view.changeteacherinfo, methods=["GET","POST"]) 
    app.add_url_rule("/changestudentinfo", view_func=view.changestudentinfo, methods=["GET","POST"])
    app.add_url_rule("/changecomment", view_func=view.changecomment, methods=["GET","POST"]) 
    app.add_url_rule("/changecomment1", view_func=view.changecomment1, methods=["GET","POST"])
